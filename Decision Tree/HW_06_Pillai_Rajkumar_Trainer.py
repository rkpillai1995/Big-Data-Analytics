...
"""
file: HW_06_Pillai_Rajkumar_Trainer.py
CSCI-720:  Big data analytics
Author: Rajkumar Lenin Pillai

Description: This program finds the attribute with minimum mixed entropy to  create the decision strump
              and generates the classifier program  as mentioned in the homework pdf
"""
...
def decision_tree(Node,data,attribute_names_list,Target_Attribute,depth):
    ...
    # ## Printing the results after finding the best splitting criteria
    # print("Best Attribute ID: ",Best_attribute_ID_to_split)
    # print("Best Attribute Name: ",best_attribute_to_split_on)
    # print("Best Bhattacharya Coeffiecent: ",best_measure_of_goodness)
    ...
    #global visited_attribute
    #visited_attribute.append(Best_attribute_ID_to_split-1)
    NodeA=[]
    NodeB=[]
    ...
    #print(len(NodeA))
    #print(len(best_attribute_to_split_on_list))
    #print()
    #print(tree)
    ...
    if len(NodeA)!=len(best_attribute_to_split_on_list):
        ...
        if str(best_attribute_to_split_on) not in tree.keys():
            tree[best_attribute_to_split_on] = []
        # print("The best parent in left call", best_attribute_to_split_on)
        # print("Befre", tree)
        ##Recursive call
        ...
        # print("Mybeest attribute: ",best_attribute_to_split_on," _0")
        # print("Next_best attribute: ", next_best)
        #
        # print("Tree: ", tree)
    ...
    if len(NodeB)!=len(best_attribute_to_split_on_list) :
        ...
        if str(best_attribute_to_split_on) not in tree.keys():
             tree[best_attribute_to_split_on] = []
        # print("The best parent in right call",best_attribute_to_split_on)
        # print("Befre",tree)
        ##Recursive call
        ...
        # print("Mybeest attribute: ", best_attribute_to_split_on,"  _1")
        # print("Next_best attribute: ", next_best)
        # print("Tree: ", tree)
...
def file_writing_recursion_left(f,parent,spacing,attribute_names_list,depth):
    ...
    # print(parent)
    # print(Index_of_parent_attribute)
...
def emit_decision_tree(f,tree,attribute_names_list):
    ...
    #print(attribute_name_x)
    #print(attribute_name_y)
    Index_of_child_attribute_x = attribute_names_list.index(attribute_name_x)
...
def emit_header():
    ...
    '''
    f = open("HW_06_Pillai_Rajkumar_Classifier.py", "w+")
    f.write('import csv')
    f.write('\n')
...
def main():
    ...
    with open('Data_Population_Survey_as_Binary_v800.csv', 'r') as csvFile:
    ...
    emit_trailer(f)
    # for item,value in enumerate(attribute_names_list):
    #     print(item," val: ",value)
