...
Description: This program implements the otsu method as well as the cost function and genertes all the plots as mentioned in the homework pdf
"""
...
def main():
    ...
    print("+++++++Using the cost function mentioned in question+++++")
